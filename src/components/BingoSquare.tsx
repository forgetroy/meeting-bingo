  ...
  return (
    <button
      ...
      className={cn(
        ...
        !isFilled && 'bg-white border-gray-200 text-gray-700 hover:border-orange-300',
        isFilled && !isFreeSpace && !isWinningSquare && 'bg-orange-500 border-orange-600 text-white',
